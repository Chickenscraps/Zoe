    ...
    <div className="space-y-8 max-w-4xl">
       <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-cream-100 text-earth-700 border-2 border-earth-700/10 hover:bg-paper-100 transition-colors text-sm"
              >
       ...
       <div className="bg-paper-100/80 border-2 border-earth-700/10 overflow-hidden">
           ...
           <div className="divide-y divide-earth-700/10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 px-6 py-4">
                   <div className="font-mono text-sm text-text-secondary">Equity</div>
           ...
           <div className="flex gap-4 flex-wrap">
               {!killConfirm ? (
                 <button
                   ...
                   className="flex items-center gap-2 px-4 py-2 bg-red-500/10 text-red-600 border-2 border-red-500/20 hover:bg-red-500/15 transition-colors text-sm font-medium"
                 >
                 ...
                 <div className="flex items-center gap-2">
                   ...
                   <button
                     ...
                     className="px-3 py-1.5 bg-red-500 text-cream-100 text-sm font-bold"
                   >
                     CONFIRM KILL
                   </button>
                   <button
                     onClick={() => setKillConfirm(false)}
                     className="px-3 py-1.5 bg-cream-100 text-text-muted border border-earth-700/10 text-sm"
                   >
                     Cancel
                   </button>
                 </div>
               ...
               <button
                 ...
                 className="flex items-center gap-2 px-4 py-2 bg-cream-100 text-earth-700 border-2 border-earth-700/10 hover:bg-paper-100 transition-colors text-sm font-medium"
               >
               ...
               {!pnlResetConfirm ? (
                 <button
                   ...
                   className="flex items-center gap-2 px-4 py-2 bg-orange-500/10 text-orange-600 border-2 border-orange-500/20 hover:bg-orange-500/15 transition-colors text-sm font-medium"
                 >
                 ...
                 <div className="flex items-center gap-2">
                   ...
                   <button
                     ...
                     className="px-3 py-1.5 bg-orange-500 text-cream-100 text-sm font-bold disabled:opacity-50"
                   >
